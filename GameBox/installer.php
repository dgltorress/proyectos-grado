...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220422_gamebox_a4ca2dea1862f0a11980_20220422174239_archive.zip';
	const ARCHIVE_SIZE		 = '34709024';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a4ca2de-22174239';
    const SECONDARY_PACKAGE_HASH = '8973b25-22174239';
	const VERSION			 = '1.4.5';
